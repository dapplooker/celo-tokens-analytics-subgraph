...
export class MooToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class MooToken extends ethereum.SmartContract {
  ...
  checkpoints(param0: Address, param1: BigInt): MooToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new MooToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<MooToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new MooToken__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
