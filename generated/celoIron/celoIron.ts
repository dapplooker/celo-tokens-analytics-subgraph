...
export class celoIron__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class celoIron extends ethereum.SmartContract {
  static bind(address: Address): celoIron {
    return new celoIron("celoIron", address);
  }
  ...
  _listBotKill(param0: BigInt): Address {
    let result = super.call("_listBotKill", "_listBotKill(uint256):(address)", [
  ...
  try__listBotKill(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "_listBotKill",
      "_listBotKill(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  checkpoints(param0: Address, param1: BigInt): celoIron__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new celoIron__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<celoIron__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new celoIron__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
...
export class KillBotFrontRunCall extends ethereum.Call {
  get inputs(): KillBotFrontRunCall__Inputs {
    return new KillBotFrontRunCall__Inputs(this);
  }

  get outputs(): KillBotFrontRunCall__Outputs {
    return new KillBotFrontRunCall__Outputs(this);
  }
}

export class KillBotFrontRunCall__Inputs {
  _call: KillBotFrontRunCall;

  constructor(call: KillBotFrontRunCall) {
    this._call = call;
  }
...
export class KillBotFrontRunCall__Outputs {
  _call: KillBotFrontRunCall;
